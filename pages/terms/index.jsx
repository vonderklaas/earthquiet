    ...
    <>
      ...
      <main>
        ...
        <div>
          ...
          <h3>Updates to this Agreement or the Website</h3>
          <p>
            We may revise this Agreement and the Website and its content at any
            time without notice and all such revisions are effective immediately
            upon posting and apply to all access to and continued use of the
            Website. By continuing to use this Website you are agreeing to be
            bound by the then current version of this Agreement.
          </p>
          <h3>Your Responsibilities</h3>
          <p>
            You are required to ensure that all persons who access the Website
            are aware of this Agreement and comply with it. The Website,
            including content or areas of the Website, may require user
            registration. It is a condition of your use of the Website that all
          ...
          <p>
            ...
            person or entity. You agree to notify us immediately of any
            unauthorized access to or use of your username or password or any
            other breach of security. You also agree to ensure that you logout
            from your account at the end of each session. You are responsible
            for any password misuse or any unauthorized access.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              authentication measures which are not authorized;
            </li>
            <li>
              (c) restricting, disrupting or disabling service to users, hosts,
              servers, or networks;
            </li>
            <li>(d) illicitly reproducing TCP/IP packet headers;</li>
            <li>
              (e) disrupting network services and otherwise disrupting our
              ability to monitor the Website;
            </li>
            <li>
              (f) using any robot, spider, or other automatic device, process,
            ...
            <li>
              (h) attacking the Website via a denial-of-service attack,
              distributed denial-of-service attack, flooding, mailbombing, or
              crashing; and
            </li>
            <li>
              (i) attacking the Website via a denial-of-service attack,
              distributed denial-of-service attack, flooding, mailbombing, or
              crashing; and
            </li>
          </ul>
          <h3>Ownership of the Website and Content</h3>
          <p>
            You understand and agree that the Website and any and all of its
            entire contents (including without limitation all text, graphics,
            interfaces, images, video, sounds, music, artwork, designs, computer
            code, data, and other elements available on or through the Website,
            and the design, structure, selection, arrangement, and look and feel
            of those items, and the Website as a whole), features, and
            functionality are owned by us, our licensors, or other providers of
            such material and are protected in all forms by intellectual
            property laws including without limitation, copyright, trademark,
            patent, trade secret, and any other proprietary rights. Your use of
            the Website does not transfer to you any right, title or interest
            in, to or associated with the Website or its content.
          </p>
          <h3>Your Limited Rights to Access and Use the Website</h3>
          <p>
            The viewing or downloading of any content, grants you only a
            limited, non-exclusive, revocable, non-transferable licence for use
          ...
          <p>
            ...
            any such third-party sites and accept no responsibility for such
            sites or for any loss or damage that may arise from your use of
            them. You are subject to any terms and conditions of such
            third-party sites.
          </p>
          <h3>Disclaimers</h3>
          <p>
          ...
          <h3>How We Limit Our Liability to You</h3>
          <p>
            EXCEPT WHERE SUCH EXCLUSIONS ARE PROHIBITED BY LAW, UNDER NO
            CIRCUMSTANCE WILL THE COMPANY NOR ITS RESPECTIVE DIRECTORS,
            OFFICERS, EMPLOYEES, AGENTS, SERVICE PROVIDERS, CONTRACTORS,
            ...
            ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT, YOUR USE, OR
            INABILITY TO USE, OR RELIANCE ON, GOODS, DIGITAL PRODUCTS, SERVICES,
            INFORMATION, THE WEBSITE, ANY LINKED WEBSITES OR SUCH OTHER
            THIRD-PARTY WEBSITES, NOR ANY WEBSITE CONTENT, MATERIALS, POSTING,
            OR INFORMATION THEREON EVEN IF COMPANY WAS ALLEGEDLY ADVISED OR HAD
            REASON TO KNOW.
          </p>
          ...
          <p>
            ...
            relating to your breach of this Agreement or your use of the Website
            including, but not limited to, third-party sites and content, any
            use of the Website's content and services other than as expressly
          ...
          <h3>Governing Law</h3>
          <p>
            The Website and this Agreement will be governed by and construed in
            accordance with the laws of Moldova and any applicable federal laws
            applicable therein, without giving effect to any choice or conflict
            of law provision, principle, or rule and notwithstanding your
            domicile, residence, or physical location.
          </p>
          <p>
            Any action or proceeding arising out of or relating to this Website
            and/or under this Agreement will be instituted in the courts of
            Moldova , and each party irrevocably submits to the exclusive
          ...
          <p>
            ...
            for the International Sale of Goods will not govern this Agreement
          ...
          <p>
            ...
            Company with respect to your access and use of the Website, its
            content and supersedes all prior and contemporaneous agreements
            between you and Company.
          </p>
          <p>
            Failure of Company to enforce any provision of this Agreement shall
          ...
          <ul>
            <li>
              ...
              sending a message to the email address you provide to us and
              consent to us using; or (ii) by posting to the Website. Notices
              sent by email will be effective when we send the email and notices
            ...
            <li>
              ...
              Notices provided by overnight courier or registered or certified
              mail will be effective once received and where confirmation has
              been provided to evidence the receipt of the notice.
            </li>
          </ul>
          <p>
            Should you become aware of misuse of the website including libelous
